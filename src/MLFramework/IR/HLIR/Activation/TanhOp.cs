...
namespace MLFramework.IR.HLIR.Activation
{
    ...
    /// </summary>
    public class TanhOp : IROperation
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TanhOp class.
        /// </summary>
        /// <param name="input">The input tensor.</param>
        /// <param name="result">The output tensor.</param>
        public TanhOp(IRValue input, IRValue result)
            : base("tanh", IROpcode.Tanh, new[] { input }, new[] { result.Type }, null)
        {
            if (input == null)
        ...
        /// <summary>
        /// Creates a new TanhOp with auto-generated result.
        /// </summary>
        public static IRValue Create(IRContext ctx, IRValue input, string name = null)
        {
            ...
            var op = new TanhOp(input, result);
        ...
        {
            return new TanhOp(Input, Result);
        }
    }
}
