...
namespace MLFramework.IR.HLIR.Elementwise
{
    ...
    /// <summary>
    /// Element-wise tensor division operation.
    /// </summary>
    public class DivOp : IROperation
    {
        /// <summary>Gets the dividend (left operand).</summary>
        public IRValue Lhs { get; }

        /// <summary>Gets the divisor (right operand).</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the DivOp class.
        /// </summary>
        /// <param name="lhs">The dividend.</param>
        /// <param name="rhs">The divisor.</param>
        /// <param name="result">The result value.</param>
        public DivOp(IRValue lhs, IRValue rhs, IRValue result)
            : base("div", IROpcode.Div, new[] { lhs, rhs }, new[] { result.Type }, null)
        {
            if (lhs == null)
        ...
        /// <summary>
        /// Creates a new DivOp with auto-generated result.
        /// </summary>
        public static IRValue Create(IRContext ctx, IRValue lhs, IRValue rhs, string name = null)
        {
            ...
            var op = new DivOp(lhs, rhs, result);
        ...
        {
            return new DivOp(Lhs, Rhs, Result);
        }
    }
}
