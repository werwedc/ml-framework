...
namespace MLFramework.IR.HLIR.Elementwise
{
    ...
    public class AddOp : IROperation
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AddOp class.
        /// </summary>
        ...
        public AddOp(IRValue lhs, IRValue rhs, IRValue result)
            : base("add", IROpcode.Add, new[] { lhs, rhs }, new[] { result.Type }, null)
        {
            if (lhs == null)
            ...
            Lhs = lhs;
            Rhs = rhs;
            // Override the result created by base class with the provided one
            Results[0] = result;
        }
        ...
        /// <summary>
        /// Validates that two shapes are compatible for broadcasting.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new AddOp with auto-generated result.
        /// </summary>
        public static IRValue Create(IRContext ctx, IRValue lhs, IRValue rhs, string name = null)
        {
            ...
            var op = new AddOp(lhs, rhs, result);
            ctx.RegisterOperation(op);
            return result;
        }

        /// <summary>
        /// Infers the broadcast shape for two tensor shapes.
        /// </summary>
        ...
        {
            return new AddOp(Lhs, Rhs, Result);
        }
    }
}
