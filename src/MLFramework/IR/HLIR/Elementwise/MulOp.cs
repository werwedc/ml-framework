...
namespace MLFramework.IR.HLIR.Elementwise
{
    ...
    /// </summary>
    public class MulOp : IROperation
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MulOp class.
        /// </summary>
        /// <param name="lhs">The left-hand operand.</param>
        /// <param name="rhs">The right-hand operand.</param>
        /// <param name="result">The result value.</param>
        public MulOp(IRValue lhs, IRValue rhs, IRValue result)
            : base("mul", IROpcode.Mul, new[] { lhs, rhs }, new[] { result.Type }, null)
        {
            if (lhs == null)
        ...
        /// <summary>
        /// Creates a new MulOp with auto-generated result.
        /// </summary>
        public static IRValue Create(IRContext ctx, IRValue lhs, IRValue rhs, string name = null)
        {
            ...
            var op = new MulOp(lhs, rhs, result);
        ...
        {
            return new MulOp(Lhs, Rhs, Result);
        }
    }
}
