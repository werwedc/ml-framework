namespace MLFramework.IR.MLIR.Elementwise
{
    ...
    /// <summary>
    /// Broadcast-aware element-wise multiplication operation in the Mid-Level IR (MLIR).
    /// </summary>
    public class BroadcastMulOp : IROperation
    {
        ...
        /// <summary>
        /// Initializes a new instance of the BroadcastMulOp class.
        /// </summary>
        ...
        public BroadcastMulOp(IRValue lhs, IRValue rhs, IRValue result, int[] broadcastShape)
            : base("broadcast_mul", IROpcode.Mul, new[] { lhs, rhs }, new[] { result.Type }, null)
        {
        ...
        {
            return new BroadcastMulOp(Lhs, Rhs, Result, BroadcastShape);
        }
    }
}
