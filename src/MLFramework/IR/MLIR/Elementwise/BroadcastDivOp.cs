namespace MLFramework.IR.MLIR.Elementwise
{
    ...
    /// <summary>
    /// Broadcast-aware element-wise division operation in the Mid-Level IR (MLIR).
    /// </summary>
    public class BroadcastDivOp : IROperation
    {
        ...
        /// <summary>
        /// Initializes a new instance of the BroadcastDivOp class.
        /// </summary>
        ...
        public BroadcastDivOp(IRValue lhs, IRValue rhs, IRValue result, int[] broadcastShape)
            : base("broadcast_div", IROpcode.Div, new[] { lhs, rhs }, new[] { result.Type }, null)
        {
        ...
        {
            return new BroadcastDivOp(Lhs, Rhs, Result, BroadcastShape);
        }
    }
}
