...
public class CachingAllocator : IMemoryAllocator
{
    ...
    /// <summary>
    /// Create a new caching allocator for the specified device
    /// </summary>
    /// <param name="device">Device to allocate memory for</param>
    ...
    /// <summary>
    /// Dispose of the allocator and free all cached memory
    /// </summary>
    public void Dispose()
    {
        EmptyCache();
