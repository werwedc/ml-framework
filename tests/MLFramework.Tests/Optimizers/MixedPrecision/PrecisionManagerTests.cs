...
namespace MLFramework.Tests.Optimizers.MixedPrecision
{
    public class PrecisionManagerTests
    {
        ...
        public void ConvertToTrainingPrecision_WithExcludedLayer_ReturnsFP32Tensor()
        {
            ...
            // Tensor should remain in FP32 since it's excluded
        }
        ...
        public void ConvertToFP32_WithNullTensor_ThrowsArgumentNullException()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => manager.ConvertToFP32((ITensor)null));
        }
        ...
        {
            return new MockTensor(precision);
        }
        ...
        private class MockTensor : ITensor
        {
            ...
            public MockTensor(Precision precision)
            {
                _precision = precision;
            }

            public Precision Precision => _precision;
        }
